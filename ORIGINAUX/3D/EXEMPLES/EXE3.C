/*************************************************************/
// TITRE  : AFFICHAGE D'UN CONE EN FACES PLEINES
// AUTEUR : Patrice SIRACUSA/wiSdom, thanks to POLLUX/Olympus
// PROJET : EXE3.C, S3D3.C, S3DREAD.C, FILLMAP.C, FILLUNI.C
...
void main(void)
{
  ...
  /* On affiche les faces de l'objet sans ordre particulier */
  param3D.affMethod = no_order;
  ...
  /* lire l'objet */
  if(!(Objet1 = readObjet_3D("cone.asc")))
    return;
