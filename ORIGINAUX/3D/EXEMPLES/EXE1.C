/*************************************************************/
// TITRE  : AFFICHAGE DES SOMMETS D'UN TORE
// AUTEUR : Patrice SIRACUSA/wiSdom
// PROJET : EXE1.C, S3D3.C, S3DREAD.C, FILLMAP.C, FILLUNI.C
...
void main(void)
{
  ...
  /* On va afficher seulement les sommets de l'objet */
  param3D.render = vertices;
  ...
  /* Couleur des sommets = 175 sur la palette */
  Objet1->coul = 175;
