/*************************************************************/
// TITRE  : AFFICHAGE D'UN TORE EN FLAT-SHADING
// AUTEUR : Patrice SIRACUSA/wiSdom, thanks to POLLUX/Olympus
// PROJET : EXE3B.C, S3D3.C, S3DREAD.C, FILLMAP.C, FILLUNI.C
...
void main(void)
{
  ...
  /* On n'utilise le flat-shading */
  param3D.shading = flat;
  /* On affiche les faces de l'objet selon un tri en z */
